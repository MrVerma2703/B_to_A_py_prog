...
def send_email(send_from, send_to, subject, text, files=None):
    ...
    smtp.starttls()
    #first get ensure that your email account allows to more secure [tip: on it from the settings]
    smtp.login #( ur_email_add , ur_password  )
...
if __name__ == "__main__":
    ...
    send_email(#send from email_Add, ['send to email_add'],
               'Jobs Posting', 'lorem hxbv jhdv',
